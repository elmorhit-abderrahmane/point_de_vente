                            ...
                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h2 class="modal-title" id="exampleModalScrollableTitle" style="color: white;">Ajouter Produit</h2>
                                    </div>
                                    <div class="modal-body">
                                        <form method="POST" action="product.php" enctype="multipart/form-data">
                                            <div class="form-group pt-20">
                                                <div class="col-sm-4">
                                                    <label for="name" class="pr-10">Nom Produit </label>
                                                </div>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group pt-20">
                                                <div class="col-sm-4">
                                                    <label for="buy" class="pr-10">  Montant d'achat</label>
                                                </div>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group pt-20">
                                                <div class="col-sm-4">
                                                    <label for="pimage" class="pr-10">Image Produit </label>
                                                </div>
                                                <div class="col-sm-8">
                                            ...
                                            <div class="form-group" style="text-align: center;">
                                                <button type="submit" value="submit" name="submit" class="btn btn-success">Ajouter</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
