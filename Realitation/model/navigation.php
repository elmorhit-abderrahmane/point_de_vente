         ...
         <nav class="navbar navbar-inverse navbar-fixed-top" id="navbar-inverse">
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav" style="color: white;">
                    <li><a class="<?php if($currentPage =='product.php'){echo 'active';}?>" href="product.php">Produit</a></li>
                    ...
                    <li class="pull-right"><a href="#">connecté en tant que <b class="user"><?php echo $user; ?></b></a></li>
