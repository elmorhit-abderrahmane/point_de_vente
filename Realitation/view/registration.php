        ...
        <form method="POST" action="registration.php" enctype="multipart/form-data">
            <div class="container reg">
                ...
                <div>
                    ...
                    <input name="name" id="name" type="text" placeholder="Entrez votre nom" required>
                </div>
                <div>
                    <label for="uname">Prénom<span>*</span></label>
                    <input name="uname" id="uname" type="text" placeholder="Entrez votre Prénom " onchange="checkUsername(this.value); checkUser(this.value);" required>
                    <small id="checktext"></small>
                    <small id="checkuser"></small>
                </div>
                <div>
                    <label for="email"> Email</label>
                    <input name="email" id="email" type="text" placeholder="Entrez votre Email" onchange="checkUsermail(this.value);">
                    <small id="checkmail"></small>
                </div>
                <div>   
                    <label for="password"> mot de passe<span>*</span></label>
                    <input name="password" id="password" type="password" placeholder="Entrer un mot de passe" onchange="checkUserpass(this.value);" required>
                    <small id="checkpass"></small>
                 </div>
                 <div>
                     <label for="rpassword">Confirmation mot de passe<span>*</span></label>
                     <input name="rpassword" id="rpassword" type="password" placeholder="Répétez le mot de passe" required>
                 </div>
                 <div style="text-align: center">
                     <p><span>***</span>En créant un compte, vous acceptez nos conditions générales.</p>
                 </div>
